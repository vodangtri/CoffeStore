...
{
    public partial class ItemsQL : UserControl
    {
        public ItemsQL()
        {
            InitializeComponent();
        ...
        private void ItemsQL_Load(object sender, EventArgs e)
        {
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            UpdateItems updateForm = new UpdateItems();
            updateForm.ItemID = ID;
            updateForm.ItemPicture = ImageLink;
            updateForm.ItemTitle = Title;
            updateForm.ItemPrice = Price;
            updateForm.ItemQuantity = TotalQuantity;
