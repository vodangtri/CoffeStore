...
>>>>>>> 4795e1e7886a8c478cb5c3980d5cd83a2dcc6e86
>>>>>>> cc0649176df20b6ad5e9f3ddeb83766ab282ec78
        ...
        public DataTable GetInfoUserDA_DAL(string idUser)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                // Tạo câu lệnh SQL để lấy dữ liệu từ bảng Account
                string sql = "SELECT FullName, Email, PhoneNumber, BirthDay, DiaChi, UserRole FROM Account";
